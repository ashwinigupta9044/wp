...
export default function Kavya() {
  ...
  const name = "Kavya Joshi";
  const avatar = "/image/page5/2.jpg";
  ...
  { id: 1, text: "Suno na ❤️", type: "received", time: "08:00", status: "" },
  { id: 2, text: "Haan jaan 😊", type: "sent", time: "08:01", status: "seen" },
  { id: 3, text: "Miss kar rahi hoon tumhe", type: "received", time: "08:02", status: "" },
  { id: 4, text: "Main bhi… bahut zyada 😔", type: "sent", time: "08:03", status: "seen" },
  { id: 5, text: "Abhi kya kar rahe ho?", type: "received", time: "08:04", status: "" },
  { id: 6, text: "Tumse baat 😄", type: "sent", time: "08:05", status: "seen" },
  { id: 7, text: "Jhoothe 😜", type: "received", time: "08:06", status: "" },
  { id: 8, text: "Sach me jaan", type: "sent", time: "08:07", status: "seen" },
  { id: 9, text: "Aaj mujhe time doge?", type: "received", time: "08:08", status: "" },
  { id: 10, text: "Tumhare liye hamesha 💖", type: "sent", time: "08:09", status: "seen" },

  { id: 11, text: "Tumhara mood kaisa hai?", type: "received", time: "08:10", status: "" },
  { id: 12, text: "Ab tumse baat karke better", type: "sent", time: "08:11", status: "seen" },
  { id: 13, text: "Awww 🥹", type: "received", time: "08:12", status: "" },
  { id: 14, text: "Tum cute ho pata hai?", type: "sent", time: "08:13", status: "seen" },
  { id: 15, text: "Sirf tumhari 😌", type: "received", time: "08:14", status: "" },
  { id: 16, text: "Meri hi rehna ❤️", type: "sent", time: "08:15", status: "seen" },
  { id: 17, text: "Hamesha", type: "received", time: "08:16", status: "" },
  { id: 18, text: "Shaadi kab karoge? 😜", type: "sent", time: "08:17", status: "seen" },
  { id: 19, text: "Jab tum bolo 😳", type: "received", time: "08:18", status: "" },
  { id: 20, text: "Phir ready rehna 😄", type: "sent", time: "08:19", status: "seen" },

  { id: 21, text: "Tum khana time pe nahi khate", type: "received", time: "08:20", status: "" },
  { id: 22, text: "Ab tum yaad dilaogi na", type: "sent", time: "08:21", status: "seen" },
  { id: 23, text: "Care karti hoon isliye", type: "received", time: "08:22", status: "" },
  { id: 24, text: "Aur main tumse pyaar karta hoon isliye", type: "sent", time: "08:23", status: "seen" },
  { id: 25, text: "Zyada romantic mat bano", type: "received", time: "08:24", status: "" },
  { id: 26, text: "Tum ho hi aisi", type: "sent", time: "08:25", status: "seen" },
  { id: 27, text: "Aaj milne aaoge?", type: "received", time: "08:26", status: "" },
  { id: 28, text: "Bas wahi aa raha hoon 😍", type: "sent", time: "08:27", status: "seen" },
  { id: 29, text: "Sach?", type: "received", time: "08:28", status: "" },
  { id: 30, text: "Kasam se ❤️", type: "sent", time: "08:29", status: "seen" },

  { id: 31, text: "Tumhare saath time fast chala jata", type: "received", time: "08:30", status: "" },
  { id: 32, text: "Kyuki hum perfect hain", type: "sent", time: "08:31", status: "seen" },
  { id: 33, text: "Self praise 😜", type: "received", time: "08:32", status: "" },
  { id: 34, text: "Sach hai", type: "sent", time: "08:33", status: "seen" },
  { id: 35, text: "Tum mujhe kabhi chhodoge to nahi?", type: "received", time: "08:34", status: "" },
  { id: 36, text: "Kabhi nahi… promise 🤞", type: "sent", time: "08:35", status: "seen" },
  { id: 37, text: "I trust you", type: "received", time: "08:36", status: "" },
  { id: 38, text: "Aur main tumhe", type: "sent", time: "08:37", status: "seen" },
  { id: 39, text: "Bas saath rehna", type: "received", time: "08:38", status: "" },
  { id: 40, text: "Hamesha ❤️", type: "sent", time: "08:39", status: "seen" },

  // 40–100 same romantic flow maintain kar sakta hoon agar chaho
