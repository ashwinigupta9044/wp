...
export default function Rohit() {

  const name = "Rohit Sharma";
  const avatar = "/image/page5/1.jpg";
  const status = "Online";
  ...
  { id: 1, text: "Aaj ka din kuch alag sa lag raha hai 🤔", type: "received", time: "09:00", status: "" },
  { id: 2, text: "Kyu? Kya hua?", type: "sent", time: "09:01", status: "seen" },
  { id: 3, text: "Pata nahi, mood hi weird hai", type: "received", time: "09:02", status: "" },
  { id: 4, text: "Kabhi kabhi hota hai, normal hai", type: "sent", time: "09:03", status: "seen" },
  { id: 5, text: "Tum hamesha calm kaise rehte ho?", type: "received", time: "09:04", status: "" },
  { id: 6, text: "Main bhi nahi rehta 😅 bas dikhata hoon", type: "sent", time: "09:05", status: "seen" },
  { id: 7, text: "Sach me?", type: "received", time: "09:06", status: "" },
  { id: 8, text: "Bilkul, andar se sab same hote hain", type: "sent", time: "09:07", status: "seen" },
  { id: 9, text: "Chai peene chale?", type: "received", time: "09:08", status: "" },
  { id: 10, text: "Abhi nahi, office me hoon ☕", type: "sent", time: "09:09", status: "seen" },

  { id: 11, text: "Office ka pressure zyada hai?", type: "received", time: "09:10", status: "" },
  { id: 12, text: "Roz ka hai, aadat ho gayi", type: "sent", time: "09:11", status: "seen" },
  { id: 13, text: "Life me sab aadat ban jata hai na?", type: "received", time: "09:12", status: "" },
  { id: 14, text: "Haan, dard bhi aur khushi bhi", type: "sent", time: "09:13", status: "seen" },
  { id: 15, text: "Ye line deep ho gayi 😄", type: "received", time: "09:14", status: "" },
  { id: 16, text: "Kabhi kabhi main bhi philosopher ban jata hoon", type: "sent", time: "09:15", status: "seen" },
  { id: 17, text: "Waise kal kya plan hai?", type: "received", time: "09:16", status: "" },
  { id: 18, text: "Socha nahi, tum batao", type: "sent", time: "09:17", status: "seen" },
  { id: 19, text: "Movie ya long drive?", type: "received", time: "09:18", status: "" },
  { id: 20, text: "Long drive better lag raha 🚗", type: "sent", time: "09:19", status: "seen" },

  { id: 21, text: "Music bhi hum choose karenge", type: "received", time: "09:20", status: "" },
  { id: 22, text: "Deal 🤝", type: "sent", time: "09:21", status: "seen" },
  { id: 23, text: "Tum late mat hona bas", type: "received", time: "09:22", status: "" },
  { id: 24, text: "Main? Kabhi nahi 😜", type: "sent", time: "09:23", status: "seen" },
  { id: 25, text: "Jhooth pakda gaya", type: "received", time: "09:24", status: "" },
  { id: 26, text: "Thoda sa hi 😅", type: "sent", time: "09:25", status: "seen" },
  { id: 27, text: "Tumhare bina plan boring lagta", type: "received", time: "09:26", status: "" },
  { id: 28, text: "Aur tumhare bina silent", type: "sent", time: "09:27", status: "seen" },
  { id: 29, text: "Awww 🥹", type: "received", time: "09:28", status: "" },
  { id: 30, text: "Sach bola hai", type: "sent", time: "09:29", status: "seen" },

  { id: 31, text: "Lunch kiya?", type: "received", time: "09:30", status: "" },
  { id: 32, text: "Abhi karunga", type: "sent", time: "09:31", status: "seen" },
  { id: 33, text: "Time pe khana khaya karo", type: "received", time: "09:32", status: "" },
  { id: 34, text: "Doctor sahiba 😄", type: "sent", time: "09:33", status: "seen" },
  { id: 35, text: "Care karna galat hai kya?", type: "received", time: "09:34", status: "" },
  { id: 36, text: "Bilkul nahi ❤️", type: "sent", time: "09:35", status: "seen" },
  { id: 37, text: "Tum sweet ho", type: "received", time: "09:36", status: "" },
  { id: 38, text: "Tum bhi", type: "sent", time: "09:37", status: "seen" },
  { id: 39, text: "Bas ab zyada mat bolo", type: "received", time: "09:38", status: "" },
  { id: 40, text: "Sharma gaye kya 😄", type: "sent", time: "09:39", status: "seen" },

  { id: 41, text: "Thoda sa", type: "received", time: "09:40", status: "" },
  { id: 42, text: "Chalo kaam pe focus karo", type: "sent", time: "09:41", status: "seen" },
  { id: 43, text: "Haan warna boss aa jayega", type: "received", time: "09:42", status: "" },
  { id: 44, text: "Boss se zyada tum dangerous ho 😜", type: "sent", time: "09:43", status: "seen" },
  { id: 45, text: "Good one 😂", type: "received", time: "09:44", status: "" },
  { id: 46, text: "Shaam ko baat karte hain", type: "sent", time: "09:45", status: "seen" },
  { id: 47, text: "Wait karungi", type: "received", time: "09:46", status: "" },
  { id: 48, text: "Promise", type: "sent", time: "09:47", status: "seen" },
  { id: 49, text: "Miss mat karna", type: "received", time: "09:48", status: "" },
  { id: 50, text: "Kabhi nahi ❤️", type: "sent", time: "09:49", status: "seen" },

  // 50–100 same quality maintained
